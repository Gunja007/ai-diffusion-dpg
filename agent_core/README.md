...
Requires `ANTHROPIC_API_KEY` (or `OPENAI_API_KEY`, `GOOGLE_API_KEY`, or `GEMINI_API_KEY`) to be set in the environment.
...
| `google-genai` | >=1.0.0 | Google Gemini SDK — used only in `chat_provider/google_provider.py` |
