...
from dev_kit.schemas.enums import (
    ...
    ANTHROPIC_MODELS, OPENAI_MODELS, OLLAMA_MODELS, GEMINI_MODELS, ALL_CHAT_MODELS, LANGUAGES,
...
def test_all_chat_models_is_union():
    assert set(ALL_CHAT_MODELS) == set(ANTHROPIC_MODELS) | set(OPENAI_MODELS) | set(OLLAMA_MODELS) | set(GEMINI_MODELS)
