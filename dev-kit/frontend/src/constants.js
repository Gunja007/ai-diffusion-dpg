...
// Block-completion status (`complete` | `incomplete`) shares this lookup table
// with deploy-service statuses (`healthy`, `running`, `starting`, `queued`, `failed`).
// The deploy-service entries are consumed by DeployStatusStep / ingest rows and
// must stay alongside the block-completion entries.
...
export const STATUS_COLORS = {
  ...
  incomplete: 'border-gray-700 bg-gray-900',
}
